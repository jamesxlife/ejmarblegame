...
function soundTest() {
  tone(660, 0.12, 0.09, "sine", 0);
  tone(880, 0.18, 0.09, "sine", 0.12);
}


function startWhistle() {
  tone(1200, 0.18, 0.09, "sine", 0);
  tone(1500, 0.20, 0.09, "sine", 0.21);
  tone(1850, 0.45, 0.10, "sine", 0.43);
}


function joltSound() {
  tone(140, 0.12, 0.11, "square", 0);
  tone(90, 0.20, 0.09, "sawtooth", 0.08);
  tone(220, 0.10, 0.06, "square", 0.15);
}
...
function winnerSound() {
  ...
  tone(1047, 0.60, 0.13, "triangle", 0.48);
}
...
function startMusic() {
  ...
  musicTimer = setInterval(() => {
    ...
    if (beat % 4 === 0) {
      tone(110, 0.10, 0.035, "triangle");
    }

    if (beat % 4 === 2) {
      tone(165, 0.07, 0.025, "triangle");
    }

    if (beat % 8 === 6) {
      tone(220, 0.05, 0.020, "sine");
    }
